...
export const RITUELS: Ritual[] = [
    ...
    },
    {
        ...
        data: {
          phases: [
            { type: 'image', name: 'ritual_salut_quantique_phase_1_name', instruction: 'ritual_salut_quantique_phase_1_instruction', duration: 40, imageUrl: 'https://www.magnetiseur-dax.fr/webapp/Aura/passe2.png' },
