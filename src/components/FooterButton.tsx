...
export const FooterButton = ({ icon, label, onClick, isActive, hasNotification = false }: { icon: ReactNode; label: string; onClick: () => void; isActive: boolean; hasNotification?: boolean; }) => (
